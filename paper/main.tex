...
% tikz not needed — architecture diagram is pre-compiled PDF
...
\thanks{$^{1}$Xiangdong Huang is with the University of Michigan,
        Ann Arbor, MI, USA.
        {\tt\small chatgpt8885huang@gmail.com}}%
}
...
directly whenever tactile input is present, while modality dropout is
